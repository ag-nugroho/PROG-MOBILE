...
const String apiKey = "8d5c9c539e810666de14ff17277a234e";
          ...
          child: Visibility(
            ...
            child: Column(
              children: [
                ...
                // Weather Data
                buildWeatherCard('Temperature', '${temp?.toInt()} ºC', 'images/thermometer.png'), // Sudah benar
                buildWeatherCard('Pressure', '$press hPa', 'images/barometer.png'),
                buildWeatherCard('Humidity', '$hum %', 'images/humidity.png'),
                buildWeatherCard('Cloud Cover', '$cover %', 'images/cloudy.png'),
              ],
            ),
          ),
        ),
